...
System.out.println(top1BtM[0]+ ","+ top1BtM[1]+ ","+ top1BtM[2]+ " "+top1BtM[3]+ " "+top1BtM[4]+ " ,"+top1BtM[5]+ ","+top1BtM[6]+ ","+top1BtM[7]+ ","+top1BtM[8]+ ","+top1BtM[9]);
System.out.println(top10IcTeR[0]+ ","+ top10IcTeR[1]+ ","+ top10IcTeR[2]+ " "+top10IcTeR[3]+ " "+top10IcTeR[4]+ " ,"+top10IcTeR[5]+ ","+top10IcTeR[6]+ ","+top10IcTeR[7]+ ","+top10IcTeR[8]+ ","+top10IcTeR[9]);
 System.out.println(iplTeamN[0]+ ","+ iplTeamN[1]+ ","+ iplTeamN[2]+ " "+iplTeamN[3]+ " "+iplTeamN[4]+ " ,"+iplTeamN[5]+ ","+iplTeamN[6]+ ","+iplTeamN[7]+ ","+iplTeamN[8]+ ","+iplTeamN[9]);                                  
			   System.out.println(top1BtM.length);
			   System.out.println(top10IcTeR.length);
			   System.out.println(iplTeamN.length);
